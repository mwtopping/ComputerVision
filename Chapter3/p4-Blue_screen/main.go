...
func init() {
	...
	img3 = ebiten.NewImage(910, 732)

	img4, _, err = ebitenutil.NewImageFromFile("FG.jpg")
	if err != nil {
		log.Fatal(err)
	}
...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	op2.GeoM.Translate(0, 732)
	screen.DrawImage(img3, op2)

	op3 := &ebiten.DrawImageOptions{}
	op3.GeoM.Translate(910, 732)
	screen.DrawImage(img4, op3)
